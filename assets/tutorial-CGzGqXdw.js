...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"assumePropsColor(BaseLabel)"}),e.jsx(B,{text:"Hello World!"})]}),e.jsxs(o.p,{children:["By default, the ",e.jsx(o.code,{children:"displayName"}),` shown in React Dev Tools will be
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"Yellow(BaseLabel)"}),e.jsx(N,{text:"Hello World!"})]}),e.jsxs(o.p,{children:["This is how it looks in React Dev Tools with a default ",e.jsx(o.code,{children:"displayName"}),":"]}),e.jsx("img",{src:"https://middle-ages.github.io/react-compinators-docs/docs/dev-tools-display-name-default.png",alt:"Dev Tools default displayName",style:{border:"2px inset",maxWidth:"20rem"}}),e.jsxs(o.p,{children:["But when we provide the ",e.jsx(o.code,{children:"Yellow"})," argument to ",e.jsx(o.code,{children:"assumeProps"})," we get:"]}),e.jsx("img",{src:"https://middle-ages.github.io/react-compinators-docs/docs/dev-tools-display-name-custom.png",alt:"Dev Tools custom displayName",style:{border:"2px inset",maxWidth:"20rem"}}),e.jsxs(o.p,{children:[`All combinators follow this pattern of taking an optional value that will
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"My(BaseLabel)"}),e.jsx(A,{text:"Hello World!"})]}),e.jsxs(o.h4,{id:"3-unfoldprop",children:["3. ",e.jsx(o.code,{children:"unfoldProp"})]}),e.jsxs(o.p,{children:["What if we wanted to partially apply ",e.jsx(o.em,{children:"three"}),` variants of the button, one for
...
`})}),e.jsxs("fieldset",{children:[e.jsxs("legend",{children:["Calling ",e.jsx("code",{children:"assumeProp"})," ",e.jsx("i",{children:"three"})," times"]}),e.jsx(Y,{text:"Green"}),e.jsx(W,{text:"Yellow"}),e.jsx(R,{text:"Red"})]}),e.jsxs(o.p,{children:["We could loop over the values, or we could use the ",e.jsx(o.code,{children:"unfoldProp"}),` combinator.
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsxs("code",{children:[e.jsx("i",{children:"Four"})," variants from a single object"]})}),e.jsx(r,{color:"green"}),e.jsx(r.Red,{text:"red"}),e.jsx(r.Yellow,{text:"yellow"}),e.jsx(r.Green,{text:"green"})]}),e.jsx(o.h3,{id:"map",children:"Map"}),e.jsx(o.p,{children:"Functions for mapping over component props."}),e.jsxs(o.h4,{id:"1-modprop",children:["1. ",e.jsx(o.code,{children:"modProp"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"modProp"}),` is used to map over a component prop without changing its type.The
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"modPropText(BaseLabel)"})}),e.jsx(k,{color:"yellow",text:"Hello World"})]}),e.jsxs(o.h4,{id:"2-mapprops",children:["2. ",e.jsx(o.code,{children:"mapProps"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"modProps"})," is actually a special case of ",e.jsx(o.code,{children:"mapProps"}),", useful when:"]}),e.jsxs(o.ol,{children:[`
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"Parent » OmitNumber(Child)"})}),e.jsx(E,{text:"Hello World!",number:123})]}),e.jsxs(o.h4,{id:"5-renameprop",children:["5. ",e.jsx(o.code,{children:"renameProp"})]}),e.jsxs(o.p,{children:[`Don't you hate it when you have the correct component, and the correct props,
...
<Component {...props} />
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"renamePropTextColorColor(BaseLabel)"})}),e.jsx(Q,{textColor:"green",text:"Hello World!"})]}),e.jsxs(o.h4,{id:"6-renameprops",children:["6. ",e.jsx(o.code,{children:"renameProps"})]}),e.jsx(o.p,{children:"When you need to rename several props:"}),e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-tsx",children:`// Unfortunately, all prop names are wrong.
...
`,e.jsx(o.code,{children:"green"})," and vice versa, and if there is no such style we set it to ",e.jsx(o.code,{children:"yellow"}),":"]}),e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-tsx",children:`const FlippedLabel = modStyle((style = {background: 'yellow'})  => ({
  color:
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"modStyle"})}),e.jsx(d,{text:"red",style:{background:"green"}}),e.jsx(d,{text:"green",style:{background:"red"}}),e.jsx(d,{text:"yellow"})]}),e.jsx(o.h3,{id:"composition",children:"Composition"}),e.jsx(o.p,{children:"The combinators can be composed as functions, for example in a pipe:"}),e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-tsx",children:`const TextLabel = ({text}) => <div>{text}</div>

const ValueQuestion = pipe(
  TextLabel,
  modProp('text', x => \`\${text}?\`),
  renameProp('text', 'value'),
);

<ValueQuestion value="What is your name">
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"Composing Combinators"}),e.jsx(X,{text:"What is your name"})]}),e.jsxs(o.h3,{id:"a-note-about-displayname",children:["A note about ",e.jsx(o.code,{children:"displayName"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"displayName"}),` is used mostly for debugging via
...
`,e.jsx(o.a,{href:"https://github.com/facebook/react/blob/main/packages/react-devtools/CHANGELOG.md#higher-order-components",rel:"nofollow",children:"here"}),"."]})]})}function te(n={}){const{wrapper:o}={...l(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(p,{...n})}):p(n)}function a(n,o){throw new Error("Expected "+(o?"component":"object")+" `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{s as BaseLabel,C as COLORS,D as Child,Q as Component1,U as Component2,G as ComponentA1,I as ComponentA2,F as ComponentB1,M as ComponentB2,d as FlippedLabel,Y as GreenLabel4,H as GreenLabel5,z as Label,r as Label1,_ as OmitNumber,E as Parent,k as QuestionLabel,R as RedLabel4,T as RedLabel5,q as TextLabel,X as ValueQuestion,B as YellowLabel1,N as YellowLabel2,A as YellowLabel3,W as YellowLabel4,S as YellowLabel5,te as default,O as mapper1,V as mapper2};
