...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"Composing Combinators"}),e.jsx(X,{value:"What is your name"})]}),e.jsxs(o.h3,{id:"a-note-about-displayname",children:["A note about ",e.jsx(o.code,{children:"displayName"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"displayName"}),` is used mostly for debugging via
