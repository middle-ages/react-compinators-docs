...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"assumePropsColor(BaseLabel)"}),e.jsx(v,{text:"Hello World!"})]}),e.jsxs(o.p,{children:["By default, the ",e.jsx(o.code,{children:"displayName"}),` shown in React Dev Tools will be
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"Yellow(BaseLabel)"}),e.jsx(C,{text:"Hello World!"})]}),e.jsxs(o.p,{children:["This is how it looks in React Dev Tools with a default ",e.jsx(o.code,{children:"displayName"}),":"]}),e.jsx("img",{src:"https://middle-ages.github.io/react-compinators-docs/docs/dev-tools-display-name-default.png",alt:"Dev Tools default displayName",style:{border:"2px inset",maxWidth:"20rem"}}),e.jsxs(o.p,{children:["But when we provide the ",e.jsx(o.code,{children:"Yellow"})," argument to ",e.jsx(o.code,{children:"assumeProps"})," we get:"]}),e.jsx("img",{src:"https://middle-ages.github.io/react-compinators-docs/docs/dev-tools-display-name-custom.png",alt:"Dev Tools custom displayName",style:{border:"2px inset",maxWidth:"20rem"}}),e.jsxs(o.p,{children:[`All combinators follow this pattern of taking an optional value that will
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"My(BaseLabel)"}),e.jsx(B,{text:"Hello World!"})]}),e.jsxs(o.h4,{id:"3-unfoldprop",children:["3. ",e.jsx(o.code,{children:"unfoldProp"})]}),e.jsxs(o.p,{children:["What if we wanted to partially apply ",e.jsx(o.em,{children:"three"}),` variants of the button, one for
...
`})}),e.jsxs("fieldset",{children:[e.jsxs("legend",{children:["Calling ",e.jsx("code",{children:"assumeProp"})," ",e.jsx("i",{children:"three"})," times"]}),e.jsx(N,{text:"Green"}),e.jsx(A,{text:"Yellow"}),e.jsx(Y,{text:"Red"})]}),e.jsxs(o.p,{children:["We could loop over the values, or we could use the ",e.jsx(o.code,{children:"unfoldProp"}),` combinator.
...
console.log(YellowLabel.displayName) // Yellow(BaseLabel)
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"unfoldProp"})}),e.jsx(R,{text:"Green"}),e.jsx(W,{text:"Yellow"}),e.jsx(H,{text:"Red"})]}),e.jsx(o.h3,{id:"variants",children:"Variants"}),e.jsx(o.p,{children:"Functions for building component variants."}),e.jsxs(o.h4,{id:"1-withvariants",children:["1. ",e.jsx(o.code,{children:"withVariants"})]}),e.jsxs(o.p,{children:[`When building a family of variants from a base component, for example, besides
building the various variants, there is the issue of `,e.jsx(o.em,{children:"import ergonomics"}),"."]}),e.jsxs(o.p,{children:[`Every variant must be exported and then imported. A common cure is adding the variants as
...
`})}),e.jsx(o.p,{children:"Which you could import and use with:"}),e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-tsx",children:`import {Label} from 'Label'
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"mapProps(ComponentA)"})}),e.jsx(S,{foo:"Hello World!"})]}),e.jsxs(o.p,{children:["In this case we are renaming a prop and changing prop type, but ",e.jsx(o.code,{children:"mapProps"}),` can
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"Parent » OmitNumber(Child)"})}),e.jsx(V,{text:"Hello World!",number:123})]}),e.jsxs(o.h4,{id:"5-renameprop",children:["5. ",e.jsx(o.code,{children:"renameProp"})]}),e.jsxs(o.p,{children:[`Don't you hate it when you have the correct component, and the correct props,
...
<Component {...props} />
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"renamePropTextColorColor(BaseLabel)"})}),e.jsx(E,{textColor:"green",text:"Hello World!"})]}),e.jsxs(o.h4,{id:"6-renameprops",children:["6. ",e.jsx(o.code,{children:"renameProps"})]}),e.jsx(o.p,{children:"When you need to rename several props:"}),e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-tsx",children:`// Unfortunately, all prop names are wrong.
const props = {value: 'Hello World!', textColor: 'green'}
...
<Component {...props} />
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"renameProps(BaseLabel)"})}),e.jsx(_,{textColor:"green",value:"Hello World!"})]}),e.jsxs(o.h3,{id:"a-note-about-displayname",children:["A note about ",e.jsx(o.code,{children:"displayName"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"displayName"})," is used mostly for debugging via ",e.jsx(o.a,{href:"https://react.dev/learn/react-developer-tools",rel:"nofollow",children:`React Dev
...
`,e.jsx(o.a,{href:"https://github.com/facebook/react/blob/main/packages/react-devtools/CHANGELOG.md#higher-order-components",rel:"nofollow",children:"here"}),"."]})]})}function oe(n={}){const{wrapper:o}={...l(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(c,{...n})}):c(n)}function a(n,o){throw new Error("Expected "+(o?"component":"object")+" `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{s as BaseLabel,L as COLORS,D as Child,E as Component1,_ as Component2,O as ComponentA1,k as ComponentA2,S as ComponentB1,M as ComponentB2,N as GreenLabel4,R as GreenLabel5,r as Label1,F as OmitNumber,V as Parent,G as QuestionLabel,Y as RedLabel4,H as RedLabel5,v as YellowLabel1,C as YellowLabel2,B as YellowLabel3,A as YellowLabel4,W as YellowLabel5,oe as default,T as mapper1,I as mapper2};
