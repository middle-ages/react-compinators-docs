...
custom `,e.jsx(o.code,{children:"displayName"})," (",e.jsx(o.code,{children:"Yellow"}),"):"]}),e.jsx(o.p,{children:e.jsx(o.img,{src:"/docs/dev-tools-display-name.png",alt:"Dev Tools Screenshot"})}),e.jsxs(o.p,{children:[`All combinators follow this pattern of taking an optional value that will
