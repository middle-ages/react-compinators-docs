...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"assumePropsColor(Label)"}),e.jsx(w,{text:"Hello World!"})]}),e.jsxs(o.p,{children:["By default, the ",e.jsx(o.code,{children:"displayName"}),` shown in React Dev Tools will be
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"Yellow(Label)"}),e.jsx(y,{text:"Hello World!"})]}),e.jsxs(o.p,{children:["This is how it looks in React Dev Tools with a default ",e.jsx(o.code,{children:"displayName"}),":"]}),e.jsx("img",{src:"https://middle-ages.github.io/react-compinators-docs/docs/dev-tools-display-name-default.png",alt:"Dev Tools default displayName",style:{border:"2px inset",maxWidth:"20rem"}}),e.jsxs(o.p,{children:["But when we provide the ",e.jsx(o.code,{children:"Yellow"})," argument to ",e.jsx(o.code,{children:"assumeProps"})," we get:"]}),e.jsx("img",{src:"https://middle-ages.github.io/react-compinators-docs/docs/dev-tools-display-name-custom.png",alt:"Dev Tools custom displayName",style:{border:"2px inset",maxWidth:"20rem"}}),e.jsxs(o.p,{children:[`All combinators follow this pattern of taking an optional value that will
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"My(Label)"}),e.jsx(P,{text:"Hello World!"})]}),e.jsxs(o.h4,{id:"3-unfoldprop",children:["3. ",e.jsx(o.code,{children:"unfoldProp"})]}),e.jsxs(o.p,{children:["What if we wanted to partially apply ",e.jsx(o.em,{children:"three"}),` variants of the button, one for
...
`})}),e.jsxs("fieldset",{children:[e.jsxs("legend",{children:["Calling ",e.jsx("code",{children:"assumeProp"})," ",e.jsx("i",{children:"three"})," times"]}),e.jsx(L,{text:"Green"}),e.jsx(v,{text:"Yellow"}),e.jsx(C,{text:"Red"})]}),e.jsxs(o.p,{children:["We could loop over the values, or we could use the ",e.jsx(o.code,{children:"unfoldProp"}),` combinator.
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"modPropText(Label)"})}),e.jsx(R,{color:"yellow",text:"Hello World"})]}),e.jsxs(o.h4,{id:"2-mapprops",children:["2. ",e.jsx(o.code,{children:"mapProps"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"modProps"})," is actually a special case of ",e.jsx(o.code,{children:"mapProps"}),", useful when:"]}),e.jsxs(o.ol,{children:[`
...
<ComponentB foo="Hello World!">
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"mapProp(ComponentA)"})}),e.jsx(k,{foo:"Hello World!"})]}),e.jsxs(o.h4,{id:"4-omitprops",children:["4. ",e.jsx(o.code,{children:"omitProps"})]}),e.jsxs(o.p,{children:[`When a parent component spreads its props to its children, there is usually some
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"Parent » OmitNumber(Child)"})}),e.jsx(I,{text:"Hello World!",number:123})]}),e.jsxs(o.h4,{id:"5-renameprop",children:["5. ",e.jsx(o.code,{children:"renameProp"})]}),e.jsxs(o.p,{children:[`Don't you hate it when you have the correct component, and the correct props,
...
for the new, and rename the prop in the given component:`]}),e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-tsx",children:`// Unfortunately, NOT Label props
const props = {text: 'Hello World!', textColor: 'pink'}

// The Label component with its color prop renamed to textColor
const Component = pipe(Label, renameProp('textColor', 'color'))

// Now we can use our props, even if the prop name is wrong
<Component {...props} />
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"renamePropTextColorColor(Label)"})}),e.jsx(D,{textColor:"pink",text:"Hello World!"})]}),e.jsxs(o.h3,{id:"a-note-about-displayname",children:["A note about ",e.jsx(o.code,{children:"displayName"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"displayName"})," is used mostly for debugging via ",e.jsx(o.a,{href:"https://react.dev/learn/react-developer-tools",rel:"nofollow",children:`React Dev
...
`,e.jsx(o.a,{href:"https://github.com/facebook/react/blob/main/packages/react-devtools/CHANGELOG.md#higher-order-components",rel:"nofollow",children:"here"}),"."]})]})}function J(n={}){const{wrapper:o}={...r(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(a,{...n})}):a(n)}export{b as COLORS,S as Child,D as Component,W as ComponentA1,T as ComponentA2,O as ComponentB1,k as ComponentB2,L as GreenLabel4,N as GreenLabel5,s as Label,G as OmitNumber,I as Parent,R as QuestionLabel,C as RedLabel4,Y as RedLabel5,w as YellowLabel1,y as YellowLabel2,P as YellowLabel3,v as YellowLabel4,A as YellowLabel5,J as default,H as mapper1,B as mapper2};
