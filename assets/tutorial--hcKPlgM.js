...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"assumePropsColor(BaseLabel)"}),e.jsx(S,{text:"Hello World!"})]}),e.jsxs(o.p,{children:["By default, the ",e.jsx(o.code,{children:"displayName"}),` shown in React Dev Tools will be
...
`})}),e.jsxs("fieldset",{children:[e.jsxs("legend",{children:["Calling ",e.jsx("code",{children:"assumeProp"})," ",e.jsx("i",{children:"three"})," times"]}),e.jsx(k,{text:"Green"}),e.jsx(W,{text:"Yellow"}),e.jsx(Y,{text:"Red"})]}),e.jsxs(o.p,{children:["We could loop over the values, or we could use the ",e.jsx(o.code,{children:"unfoldProp"}),` combinator.
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"modPropText(BaseLabel)"})}),e.jsx(T,{color:"yellow",text:"Hello World"})]}),e.jsxs(o.h4,{id:"2-mapprops",children:["2. ",e.jsx(o.code,{children:"mapProps"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"modProps"})," is actually a special case of ",e.jsx(o.code,{children:"mapProps"}),", useful when:"]}),e.jsxs(o.ol,{children:[`
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"mapProps(ComponentA)"})}),e.jsx(I,{foo:"Hello World!"})]}),e.jsxs(o.p,{children:["In this case we are renaming a prop and changing prop type, but ",e.jsx(o.code,{children:"mapProps"}),` can
...
<Flipped text="yellow" />
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"modStyle"})}),e.jsx(a,{text:"red",style:{background:"green"}}),e.jsx(a,{text:"green",style:{background:"red"}}),e.jsx(a,{text:"yellow"})]}),e.jsxs(o.h4,{id:"2-withstyle",children:["2. ",e.jsx(o.code,{children:"withStyle"})]}),e.jsxs(o.p,{children:["When you just need to ",e.jsx(o.em,{children:"add"})," or ",e.jsx(o.em,{children:"override"}),` style, you can use this specialization of
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"withStyle"})}),e.jsx($,{text:"Hello World!",style:{color:"yellow"}})]}),e.jsxs(o.h4,{id:"3-withdefaultstyle",children:["3. ",e.jsx(o.code,{children:"withDefaultStyle"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"withDefaultStyle"})," is the opposite of ",e.jsx(o.code,{children:"withStyle"}),`, in that given styles are
...
<BrightOnDark text="Hello World!" style={{color: 'yellow'}} />
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:e.jsx("code",{children:"withStyle"})}),e.jsx(K,{text:"Hello World!",style:{color:"yellow"}})]}),e.jsx(o.h3,{id:"composition",children:"Composition"}),e.jsx(o.p,{children:"The combinators can be composed as functions, for example in a pipe:"}),e.jsx(o.pre,{children:e.jsx(o.code,{className:"language-tsx",children:`import {pipe} from 'effect'
...
`})}),e.jsxs("fieldset",{children:[e.jsx("legend",{children:"Composing Combinators"}),e.jsx(ee,{value:"What is your name"})]}),e.jsxs(o.h3,{id:"a-note-about-displayname",children:["A note about ",e.jsx(o.code,{children:"displayName"})]}),e.jsxs(o.p,{children:[e.jsx(o.code,{children:"displayName"}),` is used mostly for debugging via
...
`,e.jsx(o.a,{href:"https://github.com/facebook/react/blob/main/packages/react-devtools/CHANGELOG.md#higher-order-components",rel:"nofollow",children:"here"}),"."]})]})}function ce(n={}){const{wrapper:o}={...d(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(c,{...n})}):c(n)}function t(n,o){throw new Error("Expected "+(o?"component":"object")+" `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{s as BaseLabel,$ as BrightOnDark1,K as BrightOnDark2,B as COLORS,E as Child,z as Component1,q as Component2,G as ComponentA1,F as ComponentA2,I as ComponentB1,M as ComponentB2,a as Flipped,k as GreenLabel4,H as GreenLabel5,l as Label1,Q as OmitNumber,U as Parent,T as QuestionLabel,Y as RedLabel4,O as RedLabel5,_ as Styled1,X as Styled2,J as Styled3,Z as TextLabel,ee as ValueQuestion,S as YellowLabel1,N as YellowLabel2,A as YellowLabel3,W as YellowLabel4,R as YellowLabel5,ce as default,D as mapper1,V as mapper2};
